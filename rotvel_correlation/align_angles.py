...
class TrendZ:
	...
	def plot_z_trend_histogram(self, axis: Axes = None, polar: bool = True) -> None:
		...
		if polar:
			...
			inset_axis.arrow(0, 0, 0, arrow_radius, alpha=0.5, width=0.015, edgecolor='black', facecolor='black', lw=2, zorder=5)
			inset_axis.arrow(0, 0, np.pi/2, arrow_radius, alpha=0.5, width=0.015, edgecolor='black', facecolor='black', lw=2, zorder=5)
