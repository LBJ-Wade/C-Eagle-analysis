...
class TrendZ:
    ...
    def plot_z_trends(self,
        ...
        fig = plt.figure(figsize=(12, 12))
        ax = fig.add_subplot(111)
        ax.errorbar(z_master, percent16, yerr = 5, color='green', linestyle = None, lw=1, marker='o')
        ax.errorbar(z_master, median50,  yerr = 5, color='green', linestyle = None, lw=2.5, marker='o')
        ax.errorbar(z_master, percent84, yerr = 5, color='green', linestyle = None, lw=1, marker='o')
