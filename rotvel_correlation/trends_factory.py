...
\\title{{Spin - peculiar velocity correlations: \\textsc{{{plot_type}}} }}
\\author{{Edo Altamura}} 
\\date{{\\today}} 
\\maketitle
\\begin{{abstract}}
This document is automatically generated by the plot factory pipeline.
\\newline
\\textsc{{Binning method: {x_binning.__name__}}} 
\\end{{abstract}}
