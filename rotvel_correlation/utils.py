...
output_labels = [
    ...
    '$\mathbf{J}$',
    '$\mathbf{\omega}$',
    '$M_\mathrm{aperture}$\quad[M$_\odot$]',
    ...
    '$M_{200}$\quad[M$_\odot$]',
    '$M_{2500}$\quad[M$_\odot$]',
    '$M_{500}$\quad[M$_\odot$]',
    '$M_{FoF}$\quad[M$_\odot$]',
    '$R_{200}$\quad[Mpc]',
    '$R_{2500}$\quad[Mpc]',
    '$R_{500}$\quad[Mpc]',
    '$R_\mathrm{aperture}$\quad[Mpc]',
    'Redshift',
    '$J/M$',
    'Sphericity',
    'Spin parameter',
    '$M_{sub}/M$',
    '$M_{sub}$\quad[M$_\odot$]',
    'Thermal energy',
    'Thermodynamic merging index',
    'Triaxiality',
    r'$\theta(\mathbf{v}_p, \mathbf{J})$\quad[degrees]',
    r'$\theta(\mathbf{v}_p, \mathbf{\omega})$\quad[degrees]',
    '$\mathbf{v}_{p}$\quad[km\,s$^{-1}$]'
]
