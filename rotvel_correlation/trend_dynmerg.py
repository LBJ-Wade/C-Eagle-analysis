...
class TrendDynMerg:
	...
	def make_simstats(self):
		...
		print(f"Saving npy files: dynmergindex_rot0vel4_simstats_aperture_{self.aperture_id}.npy")
		np.save(os.path.join(self.path, f'dynmergindex_rot0vel4_simstats_aperture_{self.aperture_id}.npy'), angle_master)

	def make_simbootstrap(self):

		if not os.path.isfile(os.path.join(self.path, f'dynmergindex_rot0vel4_simstats_aperture_{self.aperture_id}.npy')):
			warnings.warn(f"File dynmergindex_rot0vel4_simstats_aperture_{self.aperture_id}.npy not found.")
			print("self.make_simstats() activated.")
			self.make_simstats()

		print(f"Retrieving npy files: dynmergindex_rot0vel4_simstats_aperture_{self.aperture_id}.npy")
		angle_master = np.load(os.path.join(self.path, f'dynmergindex_rot0vel4_simstats_aperture_{self.aperture_id}.npy'))
		...
		print(f"Saving npy files: dynmergindex_rot0rot4_bootstrap_aperture_{self.aperture_id}.npy")
		np.save(os.path.join(self.path, f'dynmergindex_rot0rot4_bootstrap_aperture_{self.aperture_id}.npy'), sim_bootstrap)
	...
	def make_simhist(self):
		...
		print(f"Saving npy files: dynmergindex_rot0rot4_histogram_aperture_{self.aperture_id}.npy")
		np.save(os.path.join(self.path, f'dynmergindex_rot0rot4_histogram_aperture_{self.aperture_id}.npy'), sim_bootstrap)
	...
	def plot_z_trends(self, axis: Axes = None) -> None:
		...
		if not os.path.isfile(os.path.join(self.path, f'dynmergindex_rot0rot4_bootstrap_aperture_{self.aperture_id}.npy')):
			warnings.warn(f"File dynmergindex_rot0rot4_bootstrap_aperture_{self.aperture_id}.npy not found.")
			print("self.make_simbootstrap() activated.")
			self.make_simbootstrap()

		print(f"Retrieving npy files: dynmergindex_rot0rot4_bootstrap_aperture_{self.aperture_id}.npy")
		sim_bootstrap = np.load(os.path.join(self.path, f'dynmergindex_rot0rot4_bootstrap_aperture_'
	...
	def plot_z_trend_histogram(self, axis: Axes = None, polar: bool = True, normed: bool = True) -> None:
		...
		if not os.path.isfile(os.path.join(self.path, f'dynmergindex_rot0rot4_histogram_aperture_{self.aperture_id}.npy')):
			warnings.warn(f"File dynmergindex_rot0rot4_histogram_aperture_{self.aperture_id}.npy not found.")
			print("self.make_simhist() activated.")
			self.make_simhist()

		print(f"Retrieving npy files: dynmergindex_rot0rot4_histogram_aperture_{self.aperture_id}.npy")
		sim_hist = np.load(os.path.join(self.path, f'dynmergindex_rot0rot4_histogram_aperture_{self.aperture_id}.npy'), allow_pickle=True)
	...
	def save_z_trend(self, common_folder: bool = False) -> None:
		...
		if common_folder:
			...
			print(f"Saving {extension} figure: dynmergindex_rot0rot4_aperture_{self.aperture_id}.{extension}")
			plt.savefig(os.path.join(common_path, f'dynmergindex_rot0rot4_aperture_{self.aperture_id}.{extension}'))
	...
	def save_z_trend_hist(self, common_folder: bool = False) -> None:
		...
		if common_folder:
			...
			if not os.path.exists(common_path):
				os.makedirs(common_path)
			print(f"Saving {extension} figure: dynmergindex_rot0rot4_histogram_aperture_{self.aperture_id}.{extension}")
			plt.savefig(os.path.join(common_path, f'dynmergindex_rot0rot4_histogram_aperture_{self.aperture_id}.{extension}'))

		else:
			print(f"Saving {extension} figure: {self.simulation.simulation_name}_dynmergindex_rot0rot4_histogram_aperture_{self.aperture_id}.{extension}")
			plt.savefig(os.path.join(self.path, f'{self.simulation.simulation_name}_dynmergindex_rot0rot4_histogram_aperture_{self.aperture_id}.{extension}'), dpi=300)
...
if __name__ == '__main__':
	...
	trend_z = TrendDynMerg.run_from_dict(setup)
