...
# ***********************************
# DERIVED METHODS
def map_weighted_velocity_FoF(num_halo, redshift, simulation_type = 'gas', output = 'show' , title = True, save_name = 'Map_mass-w_velocity_', nbins = 400):
	 map_weighted_velocity(num_halo, redshift, output = output, title = title, save_name = save_name, plot_groups = 'FoF', nbins = nbins)

def map_weighted_velocity_subgroups(num_halo, redshift, simulation_type = 'gas', output = 'show' , title = True, save_name = 'Map_mass-w_velocity_', nbins = 400):
