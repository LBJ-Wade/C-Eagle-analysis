    ...
    def group_centre_of_mass(self,
        ...
        if out_allPartTypes:
            ...
            for part_type in ['0', '1', '4', '5']:
                ...
                if _mass.__len__() == 0: warnings.warn("Array is empty - check filtering.")
                if _coords.__len__() == 0: warnings.warn("Array is empty - check filtering.")
    ...
    def group_zero_momentum_frame(self,
        ...
        if out_allPartTypes:
            ...
            for part_type in ['0', '1', '4', '5']:
                ...
                if _mass.__len__() == 0: warnings.warn("Array is empty - check filtering.")
                if _velocity.__len__() == 0: warnings.warn("Array is empty - check filtering.")
