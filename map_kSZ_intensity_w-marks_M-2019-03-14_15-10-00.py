...
def map_kSZ_intensity(num_halo, redshift, simulation_type, nbins = 100, rfov = 2, output = 'show', title = True, plot_groups = 'FoF', sgth = 0):
    # Import data
    ...
    sg_x_y_pz_gn_ms, sg_y_z_px_gn_ms, sg_x_z_py_gn_ms = sgmark.subhalo_marks(path, file, sgth)
...
def call_kSZ_map(num_halo):
    ...
    map_kSZ_intensity(num_halo, redshift, simulation_type, nbins = 500, rfov = 5, output = 'save', title = True, plot_groups = plot_groups, sgth = subhalo_threshold)
