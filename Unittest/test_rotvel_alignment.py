...
class TestRotVel(unittest.TestCase):
    def test_rotvel_alignment_GAS(self):
        ...
        with h5.File(os.path.join(path, 'eagle_subfind_tab_029_z000p000.0.hdf5')) as f:
        ...
        with h5.File(os.path.join(path, 'eagle_subfind_particles_029_z000p000.0.hdf5')) as f:
