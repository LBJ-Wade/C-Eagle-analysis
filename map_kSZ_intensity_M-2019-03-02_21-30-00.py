...
def map_kSZ_intensity(num_halo, redshift, simulation_type, nbins):
    ...
    for i in [0, 1, 2]:
        ...
        kernel = kernconv.nika2_kernel(x_bins, y_bins)
    ...
    #outfilename = 'parallel-out//test//kSZ_intensity_halo' + str(num_halo) +'_z016_' + str(nbins) + 'bins.pdf'
...
def call_kSZ_map(halo):
    simulation_type = 'gas'
    map_kSZ_intensity(halo, 0.57, simulation_type = simulation_type, nbins = 200)
