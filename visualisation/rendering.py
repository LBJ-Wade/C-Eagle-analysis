...
class LosGeometry(Axes):
    ...
    def __init__(self, figure: Figure) -> None:
        ...
        self.vector_MPL_ARROWS = {'labels' : [], 'objects' : []}
    ...
    def append_vector_MPL_ARROW(self, arrow):
        self.vector_MPL_ARROWS['objects'].append(arrow)
        self.vector_MPL_ARROWS['labels'].append(arrow.get_label())
    ...
    def draw_observer(self):
        ...
        self.append_vector_MPL_ARROW(LineOfSight)
        print('[ PLOT 3D VECTOR ]\t==>\tDrawing observer_LineOfSight.')


    def get_legend(self, axes):

        leg = Legend(axes, self.vector_MPL_ARROWS['objects'], self.vector_MPL_ARROWS['labels'],
    ...
    def plot_angularmomentum_vectors(self,
        ...
        if plot_unitSphere:
            ...
            self.append_vector_MPL_ARROW(Reference_Ang_Momentum)
        ...
        if vectors.ndim == 1:
            ...
            self.append_vector_MPL_ARROW(a)
